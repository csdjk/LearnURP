...
namespace GameOldBoy.Rendering
{
    ...
    public class TAA : ScriptableRendererFeature
    {
        ...
        class TAACameraPass : ScriptableRenderPass
        {
            ...
            {
#if UNITY_2019_4_OR_NEWER
                m_ProfilingSampler = new ProfilingSampler("TAACameraPass");
#else
        ...
        class TAAPass : ScriptableRenderPass
        {
            ...
            void allocRT(out RenderTexture rt_a, out RenderTexture rt_b, CommandBuffer cmd, ScriptableRenderContext context, RenderTargetIdentifier rtid,
