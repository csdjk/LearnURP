    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                // float3 c[9];
                // DecodeSHCoefficientFromVoxel(c, _coefficientVoxel, 0);
                // float3 gi = IrradianceSH9(c, normal) / PI;

                float3 gi = SampleSHVoxel(input.positionWS, normal, _CoefficientVoxel);
                return half4(gi, 1);
            }
            ENDHLSL
        }
