...
void main(){
    ...
    //_OutlineScale == 0.015 , _OutlineWidth == 0.05
    (u_xlat11 = (_OutlineScale * _OutlineWidth));
...
//    (vs_TEXCOORD6.xyz = u_xlat2.xyz);
    //_OutlineExtdStart = 6.52 , _OutlineExtdMax = 18.16
    //view length
    ...
    (u_xlat15 = (u_xlat15 * u_xlat11));
    //u_xlat0 = tangentWS , u_xlat1 = positionVS
