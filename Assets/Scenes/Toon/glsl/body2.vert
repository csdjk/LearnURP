...
void main(){
    ...
    (u_xlatb5.xy = lessThan(ivec4(0, 0, 0, 0), ivec4(_HideCharaParts, _HideNPCParts, _HideCharaParts, _HideNPCParts)).xy);
    (u_xlati3 = ((u_xlatb5.y) ? (u_xlati1.y) : (1)));
    (u_xlati1.x = ((u_xlatb5.x) ? (u_xlati1.x) : (u_xlati3)));
