Shader "LcL/ToonHair"
{
    Properties
    {
        ...
        _BackColor ("Base Color", Color) = (1, 1, 1, 1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature TOON_HAIR
            ...
            half4 frag(Varyings input, half facing:VFACE) : SV_Target
            {
                ...
                halfLambert = clamp(halfLambert, 0.001, 1.0);
                //...
                ...
                levelShadowColor = levelShadowColor * shoadow;
                ...
                float3 testColor = levelShadowColor < 0.5 ? 0 : temp;

                // Rim Shadow
                float rimShadow = max(1 - saturate(NdotV), 0.001);
                rimShadow = pow(rimShadow, _RimShadowCt) * _RimShadowWidth;
                rimShadow = saturate(rimShadow);
                rimShadow = smoothstep(_RimShadowFeather, 1, rimShadow) * _RimShadowIntensity * 0.25;
                float3 rimColor = rimShadow * _RimShadowColor.rgb;
