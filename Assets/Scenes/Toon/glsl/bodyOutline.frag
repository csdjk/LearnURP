...
uniform float _ES_OutLineDarkenVal;
uniform float _ES_OutLineLightedVal;
...
layout(location = 0) uniform sampler2D _LightMap;
layout(location = 1) uniform sampler2D _MaterialValuesPackLUT;
layout(location = 2) uniform sampler2D _ES_GradientAtlas;
...
void main(){
    ...
    (u_xlati0 = ((-_TestMatIDLUTEnabled) + 1));
    (u_xlati0 = (u_xlati0 * _UseMaterialValuesLUT));
    debugColor = u_xlati0.xxx;

    if ((u_xlati0 != 0))
    {
        (u_xlat16_0.x = texture(_LightMap, vs_TEXCOORD0.xy).w);
        (u_xlat16_1.x = (u_xlat16_0.x * 8.0));
        (u_xlat16_1.x = floor(u_xlat16_1.x));
        (u_xlatu0.x = uint(int(u_xlat16_1.x)));
        (u_xlatu0.y = 2u);
        (u_xlatu0.z = 0u);
        (u_xlatu0.w = 0u);
        (u_xlat0.xyz = texelFetch(_MaterialValuesPackLUT, ivec2(u_xlatu0.xy), int(u_xlatu0.w)).xyz);
        (u_xlat16_1.xyz = u_xlat0.xyz);
    }
    else
    {
        (u_xlat16_1.xyz = _OutlineColor0.xyz);
    }
    (u_xlat16_25 = (_ES_CharacterDisableLocalMainLight + 1.0));
    (u_xlat16_25 = (u_xlat16_25 + (-abs(_DisableCharacterLocalLight.x))));
    (u_xlatb0 = (0.5 < u_xlat16_25));
    (u_xlat0.xyz = ((bool(u_xlatb0)) ? (_MainLightPosition.xyz) : (_CharacterLocalMainLightPosition.xyz)));
    (u_xlatb24 = (0.5 < _IsMonster));
    (u_xlat16_2.xyz = ((bool(u_xlatb24)) ? (_ES_MonsterLightDir.xyz) : (u_xlat0.xyz)));
    (u_xlat16_3.xyz = ((-u_xlat16_2.xyz) + _CustomMainLightDir.xyz));
    (u_xlat16_2.xyz = ((_CustomMainLightDir.www * u_xlat16_3.xyz) + u_xlat16_2.xyz));
    (u_xlat16_2.xyz = ((bool(u_xlatb24)) ? (_ES_MonsterLightDir.xyz) : (u_xlat16_2.xyz)));
    //NdotL
    (u_xlat0.x = dot(u_xlat16_2.xyz, vs_TEXCOORD8.xyz));
//smoothstep
    (u_xlat16_25 = (u_xlat0.x * 6.6666665));
...
//
    ...
    (u_xlat16_2.x = ((-_ES_OutLineDarkenVal) + 1.0));
    (u_xlat16_10 = ((-u_xlat16_2.x) + 1.0));
    (u_xlat16_2.x = ((u_xlat16_25 * u_xlat16_10) + u_xlat16_2.x));

    (u_xlat16_25 = (u_xlat16_25 * _ES_OutLineLightedVal));

    (u_xlat16_1.xyz = ((u_xlat16_1.xyz * u_xlat16_2.xxx) + vec3(u_xlat16_25)));
    (u_xlat16_25 = ((-_OutlineColorIntensity) + 1.0));

    (u_xlat16_1.xyz = (vec3(u_xlat16_25) * u_xlat16_1.xyz));
    (u_xlat16_25 = (((-_GlobalOneMinusAvatarIntensityEnable) * _GlobalOneMinusAvatarIntensity) + 1.0));
    (u_xlat16_1.xyz = (vec3(u_xlat16_25) * u_xlat16_1.xyz));
    (u_xlat16_25 = (((-_OneMinusGlobalMainIntensityEnable) * _OneMinusGlobalMainIntensity) + 1.0));

    debugColor = vs_TEXCOORD6.xxx;
    (u_xlat16_2.xyz = (vec3(u_xlat16_25) * u_xlat16_1.xyz));
//    debugColor = u_xlat16_25.xyz;

    //Fog
    (u_xlat0.xyz = (vs_TEXCOORD6.xyz + (-_WorldSpaceCameraPos.xyz)));
    (u_xlat0.x = dot(u_xlat0.xyz, u_xlat0.xyz));
    (u_xlat0.x = sqrt(u_xlat0.x));
    (u_xlat16_3.xz = vec2(_ES_FogNear, _ES_FogDensity));
    (u_xlat16_3.yw = vec2(_ES_HeightFogFogNear, _ES_HeightFogDensity));
    (u_xlat16_4.x = _ES_FogFar);
    (u_xlat16_4.y = _ES_HeightFogFogFar);
    (u_xlat16_20.xy = ((-u_xlat16_3.xy) + u_xlat16_4.xy));
    (u_xlat16_3.xy = ((vec2(vec2(_ES_FogCharacterNearFactor, _ES_FogCharacterNearFactor)) * u_xlat16_20.xy) + u_xlat16_3.xy));
    (u_xlat16_20.xy = (u_xlat0.xx + (-u_xlat16_3.xy)));
    (u_xlat16_3.xy = ((-u_xlat16_3.xy) + u_xlat16_4.xy));
    (u_xlat16_3.xy = (u_xlat16_20.xy / u_xlat16_3.xy));
    (u_xlat16_3.xy = clamp(u_xlat16_3.xy, 0.0, 1.0));
    (u_xlat16_3.xy = (u_xlat16_3.xy * u_xlat16_3.zw));
    (u_xlat16_19.xy = (((-u_xlat16_3.xy) * u_xlat16_3.xy) + u_xlat16_3.xy));
    (u_xlat16_0.xy = ((u_xlat16_3.xy * u_xlat16_19.xy) + u_xlat16_3.xy));
    (u_xlat16_26 = dot(vs_TEXCOORD6.xyz, hlslcc_mtx4x4_ES_GlobalRotMatrix[3].xyz));
    (u_xlat16_26 = (u_xlat16_26 + (-hlslcc_mtx4x4_ES_GlobalRotMatrix[3].w)));
    (u_xlatb5 = (0.0 < _ES_HeightFogRange));
    (u_xlat16_3.x = (u_xlat16_26 + (-_ES_HeightFogBaseHeight)));
    (u_xlat16_26 = ((-u_xlat16_26) + _ES_HeightFogBaseHeight));
    (u_xlat16_26 = ((u_xlatb5) ? (u_xlat16_3.x) : (u_xlat16_26)));
    (u_xlat16_3.x = (abs(_ES_HeightFogRange) + 1.0));
    (u_xlat16_26 = max(u_xlat16_26, 0.0));
    (u_xlat16_26 = (u_xlat16_26 / u_xlat16_3.x));
    (u_xlat16_26 = min(u_xlat16_26, 1.0));
    (u_xlat16_26 = ((-u_xlat16_26) + 1.0));
    (u_xlat16_3.x = ((u_xlat16_26 * _ES_HeightFogDensity) + -1.0));
    (u_xlat16_3.x = clamp(u_xlat16_3.x, 0.0, 1.0));
    (u_xlat16_0.z = ((_ES_TransitionRate * 0.125) + _ES_FogColor));
    (u_xlat16_5.xyz = textureLod(_ES_GradientAtlas, u_xlat16_0.xz, 0.0).xyz);
    (u_xlat16_11 = (_ES_FogDensity + -1.0));
    (u_xlat16_11 = clamp(u_xlat16_11, 0.0, 1.0));
    (u_xlat16_19.xy = u_xlat16_0.xy);
    (u_xlat16_19.xy = clamp(u_xlat16_19.xy, 0.0, 1.0));
    (u_xlat16_4.xyz = ((u_xlat16_5.xyz * u_xlat16_19.xxx) + (-u_xlat16_2.xyz)));
    (u_xlat16_4.xyz = ((u_xlat16_19.xxx * u_xlat16_4.xyz) + u_xlat16_2.xyz));
    (u_xlat16_6.xyz = ((u_xlat16_5.xyz * u_xlat16_19.xxx) + u_xlat16_4.xyz));
    (u_xlat16_4.xyz = ((u_xlat16_6.xyz * vec3(u_xlat16_11)) + u_xlat16_4.xyz));
    (u_xlat16_0.w = ((_ES_TransitionRate * 0.125) + _ES_HeightFogColor));
    (u_xlat16_5.xyz = textureLod(_ES_GradientAtlas, u_xlat16_0.yw, 0.0).xyz);
    (u_xlat16_6.xyz = (vec3(u_xlat16_26) * u_xlat16_5.xyz));
    (u_xlat16_7.xyz = ((u_xlat16_6.xyz * u_xlat16_19.yyy) + (-u_xlat16_4.xyz)));
    (u_xlat16_7.xyz = ((u_xlat16_19.yyy * u_xlat16_7.xyz) + u_xlat16_4.xyz));
    (u_xlat16_6.xyz = ((u_xlat16_6.xyz * u_xlat16_19.yyy) + u_xlat16_7.xyz));
    (u_xlat16_3.xyz = ((u_xlat16_6.xyz * u_xlat16_3.xxx) + u_xlat16_7.xyz));
    (u_xlat16_28 = max(u_xlat16_5.z, u_xlat16_5.y));
    (u_xlat16_28 = max(u_xlat16_28, u_xlat16_5.x));
    (u_xlat16_6.xyz = (vec3(u_xlat16_26) * u_xlat16_3.xyz));
    (u_xlat16_6.xyz = ((u_xlat16_6.xyz * u_xlat16_19.yyy) + u_xlat16_4.xyz));
    (u_xlat16_3.xyz = ((-u_xlat16_4.xyz) + u_xlat16_3.xyz));
    (u_xlat16_3.xyz = ((vec3(u_xlat16_26) * u_xlat16_3.xyz) + u_xlat16_4.xyz));
    (u_xlat16_26 = ((_ES_HeightFogAddAjust * (-u_xlat16_28)) + u_xlat16_28));
    (u_xlat16_4.xyz = ((-u_xlat16_3.xyz) + u_xlat16_6.xyz));
    (u_xlat16_3.xyz = ((vec3(u_xlat16_26) * u_xlat16_4.xyz) + u_xlat16_3.xyz));
    (u_xlat16_1.xyz = (((-u_xlat16_1.xyz) * vec3(u_xlat16_25)) + u_xlat16_3.xyz));

    (SV_Target0.xyz = ((vec3(u_xlat16_25) * u_xlat16_1.xyz) + u_xlat16_2.xyz));
    (SV_Target0.w = 0.0);
