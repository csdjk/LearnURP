...
layout(std140, binding = 2) uniform CharacterOutlineBuffer{
  ...
  float Xhlslcc_UnusedX_OutlineExtdStart;
  float Xhlslcc_UnusedX_OutlineExtdMax;
  float Xhlslcc_UnusedX_OutlineOffset;
...
void main(){
  (u_xlat16_0.x = -0.206);
  (u_xlat16_0.y = 0.96100003);
  (u_xlat16_0.z = _OutlineFixSide);
...
//u_xlat1 = viewOS
  (u_xlat16_6.z = ((u_xlat1.x * u_xlat19) + -0.1));
  (u_xlat16_0.x = dot(u_xlat16_0.xyz, u_xlat2.xyz));
  (u_xlat16_1.y = -0.206);
  (u_xlat16_1.z = 0.96100003);
  (u_xlat16_1.xw = (-vec2(_OutlineFixFront, _OutlineFixSide)));
  (u_xlat16_6.x = dot(u_xlat16_1.yzw, u_xlat2.xyz));
  (u_xlat16_12 = dot(vec2(0.075999998, 0.96100003), u_xlat2.xy));
  (u_xlat16_0.x = max(u_xlat16_6.x, u_xlat16_0.x));
  (u_xlat16_0.x = clamp(u_xlat16_0.x, 0.0, 1.0));
  (u_xlat16_0.x = ((-u_xlat16_0.x) + 0.10000002));
  (u_xlat16_0.x = (u_xlat16_0.x * 9.9999981));
  (u_xlat16_0.x = max(u_xlat16_0.x, 0.0));
  (u_xlat16_6.x = ((u_xlat16_0.x * -2.0) + 3.0));
  (u_xlat16_0.x = (u_xlat16_0.x * u_xlat16_0.x));
  (u_xlat16_0.x = (u_xlat16_0.x * u_xlat16_6.x));
  (u_xlat16_0.x = min(u_xlat16_0.x, 1.0));
  (u_xlat16_6.x = u_xlat16_12);
  (u_xlat16_6.x = clamp(u_xlat16_6.x, 0.0, 1.0));
  (u_xlat16_12 = ((-u_xlat16_12) + 1.0));
  (u_xlat16_6.x = (u_xlat16_1.x + u_xlat16_6.x));
  (u_xlat16_6.xz = (u_xlat16_6.xz * vec2(20.0, 4.9999995)));
  (u_xlat16_6.xz = clamp(u_xlat16_6.xz, 0.0, 1.0));
  (u_xlat16_3.x = ((u_xlat16_6.x * -2.0) + 3.0));
  (u_xlat16_6.x = (u_xlat16_6.x * u_xlat16_6.x));
  (u_xlat16_6.x = (u_xlat16_6.x * u_xlat16_3.x));
  (u_xlat16_0.x = max(u_xlat16_0.x, u_xlat16_6.x));
  (u_xlat16_0.x = min(u_xlat16_0.x, 1.0));
  (u_xlat2.x = (u_xlat16_0.x + -1.0));
  (u_xlat2.x = ((in_COLOR0.y * u_xlat2.x) + 1.0));
  (u_xlat2.x = (u_xlat2.x * _OutlineWidth));
  (u_xlat2.x = (u_xlat2.x * _OutlineScale));
  (u_xlat16_0.x = ((u_xlat16_6.z * -2.0) + 3.0));
  (u_xlat16_6.x = (u_xlat16_6.z * u_xlat16_6.z));
  (u_xlat16_0.x = (u_xlat16_6.x * u_xlat16_0.x));
  (u_xlat16_6.xz = ((-vec2(_OutlineFixRange1, _OutlineFixRange2)) + vec2(_OutlineFixRange3, _OutlineFixRange4)));
  (u_xlat16_0.xy = ((u_xlat16_0.xx * u_xlat16_6.xz) + vec2(_OutlineFixRange1, _OutlineFixRange2)));
  (u_xlat16_12 = ((-u_xlat16_0.x) + u_xlat16_12));
  (u_xlat16_0.x = ((-u_xlat16_0.x) + u_xlat16_0.y));
  (u_xlat16_0.x = (1.0 / u_xlat16_0.x));
  (u_xlat16_0.x = (u_xlat16_0.x * u_xlat16_12));
  (u_xlat16_0.x = clamp(u_xlat16_0.x, 0.0, 1.0));
  (u_xlat16_6.x = ((u_xlat16_0.x * -2.0) + 3.0));
  (u_xlat16_0.x = (u_xlat16_0.x * u_xlat16_0.x));
  (u_xlat16_0.x = (u_xlat16_0.x * u_xlat16_6.x));
  (u_xlat8.x = (u_xlat16_0.x * in_COLOR0.z));
  (u_xlatb14.xy = lessThan(vec4(0.0, 0.0, 0.0, 0.0), in_COLOR0.zyzy).xy);
  (u_xlat8.x = ((u_xlatb14.x) ? (u_xlat8.x) : (in_COLOR0.w)));
  (u_xlatb14.x = (in_COLOR0.y < 1.0));
  (u_xlatb14.x = (u_xlatb14.y && u_xlatb14.x));
  (u_xlat14 = ((u_xlatb14.x) ? (1.0) : (0.0)));
  (u_xlat8.x = ((u_xlat14 * _FixLipOutline) + u_xlat8.x));
  (u_xlat2.x = (u_xlat8.x * u_xlat2.x));
  (u_xlat8.xyz = (hlslcc_mtx4x4unity_MatrixV[1].xyz * hlslcc_mtx4x4unity_ObjectToWorld[1].yyy));
  (u_xlat8.xyz = ((hlslcc_mtx4x4unity_MatrixV[0].xyz * hlslcc_mtx4x4unity_ObjectToWorld[1].xxx) + u_xlat8.xyz));
  (u_xlat8.xyz = ((hlslcc_mtx4x4unity_MatrixV[2].xyz * hlslcc_mtx4x4unity_ObjectToWorld[1].zzz) + u_xlat8.xyz));
  (u_xlat8.xyz = ((hlslcc_mtx4x4unity_MatrixV[3].xyz * hlslcc_mtx4x4unity_ObjectToWorld[1].www) + u_xlat8.xyz));
  (u_xlat8.xyz = (u_xlat8.xyz * in_POSITION0.yyy));
  ...
  (u_xlat8.xyz = ((u_xlat4.xyz * in_POSITION0.xxx) + u_xlat8.xyz));
  (u_xlat4.xyz = (hlslcc_mtx4x4unity_MatrixV[1].xyz * hlslcc_mtx4x4unity_ObjectToWorld[2].yyy));
  ...
  (u_xlat8.xyz = ((u_xlat4.xyz * in_POSITION0.zzz) + u_xlat8.xyz));
  (u_xlat4.xyz = (hlslcc_mtx4x4unity_MatrixV[1].xyz * hlslcc_mtx4x4unity_ObjectToWorld[3].yyy));
  (u_xlat4.xyz = ((hlslcc_mtx4x4unity_MatrixV[0].xyz * hlslcc_mtx4x4unity_ObjectToWorld[3].xxx) + u_xlat4.xyz));
  (u_xlat4.xyz = ((hlslcc_mtx4x4unity_MatrixV[2].xyz * hlslcc_mtx4x4unity_ObjectToWorld[3].zzz) + u_xlat4.xyz));
  (u_xlat4.xyz = ((hlslcc_mtx4x4unity_MatrixV[3].xyz * hlslcc_mtx4x4unity_ObjectToWorld[3].www) + u_xlat4.xyz));
  (u_xlat8.xyz = (u_xlat8.xyz + u_xlat4.xyz));
  (u_xlat4.x = (u_xlat8.z / hlslcc_mtx4x4unity_CameraProjection[1].y));
  (u_xlat4.x = (abs(u_xlat4.x) / _OutlineScale));
  (u_xlat4.x = inversesqrt(u_xlat4.x));
  (u_xlat4.x = (1.0 / u_xlat4.x));
  (u_xlatb10 = (vec4(0.0, 0.0, 0.0, 0.0) != vec4(_ES_OutlineDisableDistanceScale)));
  (u_xlat4.x = ((u_xlatb10) ? (_ES_OutlineFallbackScale) : (u_xlat4.x)));
  (u_xlat2.x = (u_xlat2.x * u_xlat4.x));
  (u_xlat16_0.x = ((-_OneMinusCharacterOutlineWidthScale) + 1.0));
  ...
  (u_xlat4.y = dot(u_xlat5.xyz, in_TANGENT0.xyz));
  (u_xlat4.z = -0.1);
  (u_xlat22 = dot(u_xlat4.xyz, u_xlat4.xyz));
  (u_xlat22 = inversesqrt(u_xlat22));
  (u_xlat4.xyz = (vec3(u_xlat22) * u_xlat4.xyz));
  (u_xlat0.xyz = ((u_xlat4.xyz * u_xlat2.xxx) + u_xlat8.xyz));
  ...
  (u_xlat2.x = hlslcc_mtx4x4glstate_matrix_projection[2].w);
  (u_xlat2.y = hlslcc_mtx4x4glstate_matrix_projection[3].w);
  (u_xlat1.w = dot(u_xlat2.xy, u_xlat0.zw));
  (u_xlat16_3.xy = (in_COLOR0.yx * vec2(256.0, 256.0)));
  (u_xlati2.xy = ivec2(u_xlat16_3.xy));
  (u_xlati2.xy = ivec2(uvec2((uint(u_xlati2.x) & uint(_ShowPartID)), (uint(u_xlati2.y) & uint(_ShowPartID)))));
  (u_xlatb14.xy = lessThan(ivec4(0, 0, 0, 0), ivec4(_HideCharaParts, _HideNPCParts, _HideCharaParts, _HideNPCParts)).xy);
  (u_xlati8 = ((u_xlatb14.y) ? (u_xlati2.y) : (1)));
  (u_xlati2.x = ((u_xlatb14.x) ? (u_xlati2.x) : (u_xlati8)));
  (u_xlatb2 = (0 < u_xlati2.x));
  (gl_Position = ((bool(u_xlatb2)) ? (u_xlat1) : (vec4(-99.0, -99.0, -99.0, 1.0))));
